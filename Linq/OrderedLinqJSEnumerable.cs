...
namespace System.Linq {
	...
	public class OrderedLinqJSEnumerable<TElement> : LinqJSEnumerable<TElement>, IOrderedEnumerable<TElement> {
		...
		IOrderedEnumerable<TElement> IOrderedEnumerable<TElement>.ThenBy<TKey>(Func<TElement, TKey> keySelector) { return null; }
		...
		IOrderedEnumerable<TElement> IOrderedEnumerable<TElement>.ThenByDescending<TKey>(Func<TElement, TKey> keySelector) { return null; }
